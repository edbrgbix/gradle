...
Lockfiles using Windows line endings will continue to work, but no longer can be generated.

If you have generated and committed lockfiles on Windows, on the next lock update using Gradle 9.5.0 or above, all line endings will change, regardless of dependency changes.
